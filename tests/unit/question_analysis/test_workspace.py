...
def test_manifest_round_trip_and_frozen_layout(tmp_path: Path) -> None:
    ...
    assert set(manifest.resources) == {
        ...
        "segment7_checkpoint_source",
        "segment7_execution_source",
        "segment7_laplace_source",
        "segment7_model_source",
        "segment7_operations",
        "segment7_packed_source",
        "segment7_pipeline_source",
        "segment7_profile_script",
        "segment7_propagation_source",
        "segment7_reference_sha256",
        "segment7_reference_source",
        "segment7_synthetic_calibration_runner",
        "segment7_synthetic_contract",
        "segment7_synthetic_design_generator",
        "segment7_synthetic_diagnosis",
        "segment7_synthetic_production_design",
        "segment7_synthetic_recovery_runner",
